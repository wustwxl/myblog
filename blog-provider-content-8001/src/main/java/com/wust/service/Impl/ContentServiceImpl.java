...
import com.wust.mapper.ContentVoMapper;
import com.wust.mapper.MetaVoMapper;
import com.wust.service.IContentService;
import com.wust.service.IMetaService;
import com.wust.service.IRelationshipService;
...
public class ContentServiceImpl implements IContentService {
	...
	@Value("${MAX_TITLE_COUNT}")
	private int MAX_TITLE_COUNT;
	...
	public String publish(ContentVo contents) {
		...
		if (titleLength > MAX_TITLE_COUNT) {
			return "文章标题过长";
		}
		int contentLength = contents.getContent().length();
		if (contentLength > MAX_TEXT_COUNT) {
			return "文章内容过长";
		}
		...
		int time = Integer.parseInt(DateUtil.getCurrDateTimeStr());
	...
	public void updateContentByCid(ContentVo contentVo) {
		...
		contentVo.setModified(DateKit.getCurrentUnixTime());
